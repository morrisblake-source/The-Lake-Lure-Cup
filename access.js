...
async function unlock(code){if(await hash(code)!==ACCESS_HASH)return false;localStorage.setItem(ACCESS_KEY,ACCESS_HASH);localStorage.removeItem("ll-intro-seen-845");await boot();return true}
